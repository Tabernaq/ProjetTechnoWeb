 ...
 */
final class Version20220428145646 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__im22_GoatCommand AS SELECT id, quantite, race FROM im22_GoatCommand');
        $this->addSql('DROP TABLE im22_GoatCommand');
        $this->addSql('CREATE TABLE im22_GoatCommand (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, quantite INTEGER NOT NULL, race INTEGER NOT NULL)');
        $this->addSql('INSERT INTO im22_GoatCommand (id, quantite, race) SELECT id, quantite, race FROM __temp__im22_GoatCommand');
        $this->addSql('DROP TABLE __temp__im22_GoatCommand');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__im22_GoatCommand AS SELECT id, quantite, race FROM im22_GoatCommand');
        $this->addSql('DROP TABLE im22_GoatCommand');
        $this->addSql('CREATE TABLE im22_GoatCommand (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, quantite INTEGER NOT NULL, race CLOB NOT NULL)');
        $this->addSql('INSERT INTO im22_GoatCommand (id, quantite, race) SELECT id, quantite, race FROM __temp__im22_GoatCommand');
        $this->addSql('DROP TABLE __temp__im22_GoatCommand');
        $this->addSql('DROP INDEX UNIQ_E4171AFC19EB6921');
        $this->addSql('CREATE TEMPORARY TABLE __temp__im22_Panier AS SELECT id, client_id, total_price FROM im22_Panier');
