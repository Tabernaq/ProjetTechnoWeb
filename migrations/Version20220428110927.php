 ...
 */
final class Version20220428110927 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__goat_command AS SELECT id FROM goat_command');
        $this->addSql('DROP TABLE goat_command');
        $this->addSql('CREATE TABLE goat_command (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, quantite_tab CLOB NOT NULL --(DC2Type:array)
        )');
        $this->addSql('INSERT INTO goat_command (id) SELECT id FROM __temp__goat_command');
        $this->addSql('DROP TABLE __temp__goat_command');
