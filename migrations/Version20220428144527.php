 ...
 */
final class Version20220428144527 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE im22_GoatCommand ADD COLUMN race CLOB NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__im22_GoatCommand AS SELECT id, quantite FROM im22_GoatCommand');
        ...
        $this->addSql('INSERT INTO im22_GoatCommand (id, quantite) SELECT id, quantite FROM __temp__im22_GoatCommand');
